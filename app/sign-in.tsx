    ...
    <SafeAreaView className='bg-white h-full'>
      <ScrollView contentContainerClassName='h-full'>
        ...
        <View className='px-10'>
            ...
            <Text className='text-3xl font-rubik-bol text-black-300 text-center mt-2'>Let's Get You Closer to {"\n"}
                <Text className='text-primary-300'>Your Ideal Home</Text>
            </Text>
            
            <Text className='text-lg font-rubik text-black-200 text-center mt-12'>
                Log in ReState with Google
            </Text>
            ...
            <TouchableOpacity className='bg-white shadow-md shadow-zinc-300 rounded-full w-full py-4 mt-5' onPress={handleLogin}>
                ...
                <View className='flex flex-row items-center justify-center'>
                    ...
                    resizeMode='contain'
                />
                <Text className='font-rubik-medium ml-2 text-black-300'>Continue with Google</Text>
                </View>
